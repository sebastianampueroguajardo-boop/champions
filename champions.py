...
with tab1:
    ...
    st.subheader("en el histograma se muestra la cantidad de partidos que tuvieron cierta cantidad de goles y el otro grafico muestra la cantidad de partidos por año")
